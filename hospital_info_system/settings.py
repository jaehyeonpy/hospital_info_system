"""
Django settings for hospital_info_system project.
...
ROOT_URLCONF = 'hospital_info_system.urls'
...
WSGI_APPLICATION = 'hospital_info_system.wsgi.application'
